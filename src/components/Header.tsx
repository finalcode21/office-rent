...
export default function Header() 
{
 ...
 <header className="flex flex-col w-full">
            <section id="Hero-Banner" className="relative flex h-[720px] -mb-[93px]">
              ...
              >
                <div className="flex items-center w-fit rounded-full py-2 px-4 gap-2.5 bg-[#000929]">
                  <Image width={20} height={20} src="/assets/images/icons/crown-white.svg" className="w-5 h-5" alt="icon" />
                ...
                <div className="flex items-center gap-5">
                  ...
                  >
                    <Image width={30} height={30} src="/assets/images/icons/slider-horizontal-white.svg" className="w-[30px] h-[30px]" alt="icon" />
                  ...
                  >
                    <Image width={30} height={30} src="/assets/images/icons/video-octagon.svg" className="w-[30px] h-[30px]" alt="icon" />
              ...
              >
                <Image width={2700} height={2160} src="/assets/images/backgrounds/banner.webp" className="w-full h-full object-cover" alt="hero background" />
              </div>
            </section>
            <div className="flex flex-col pt-[150px] pb-10 px-[120px] gap-10 bg-[#0D903A]">
              <div className="logo-contianer flex items-center justify-center flex-wrap max-w-[1130px] h-[38px] mx-auto gap-[60px]">
                <Image width={185} height={24} src="/assets/images/logos/TESLA.svg" alt="clients logo" />
                <Image width={96} height={38} src="/assets/images/logos/Libra 2.svg" alt="clients logo" />
                <Image width={177} height={36} src="/assets/images/logos/Binance logo.svg" alt="clients logo" />
                <Image width={145} height={28} src="/assets/images/logos/Facebook 7.svg" alt="clients logo" />
                <Image width={141} height={30} src="/assets/images/logos/Microsoft 6.svg" alt="clients logo" />
              </div>
